...
class ProcessorTest(unittest.TestCase):
    ...
    def test_create_instance(self):
        ...
        processor = Processor()
        self.assertEquals(IProcessorConstants.ARCH_X86, processor.getArchitecture())
        self.assertEquals(IProcessorConstants.ST_UNKNOW, processor.getCPUStatus())
        ...
        self.assertEquals(IProcessorConstants.PROC_TYPE_OTHER, processor.getProcessorType())
        self.assertTrue(implements(processor, IHardware, IProcessor))
        
    def test_set_get_architecture(self):
        self.assertEquals(IProcessorConstants.ARCH_X86, self.processor.setArchitecture(0))
        self.assertEquals(IProcessorConstants.ARCH_X86, self.processor.getArchitecture())
        self.assertEquals(IProcessorConstants.ARCH_MIPS, self.processor.setArchitecture(1))
        self.assertEquals(IProcessorConstants.ARCH_MIPS, self.processor.getArchitecture())
        self.assertEquals(IProcessorConstants.ARCH_ALPHA, self.processor.setArchitecture(2))
        self.assertEquals(IProcessorConstants.ARCH_ALPHA, self.processor.getArchitecture())
        self.assertEquals(IProcessorConstants.ARCH_POWER_PC, self.processor.setArchitecture(3))
        self.assertEquals(IProcessorConstants.ARCH_POWER_PC, self.processor.getArchitecture())
        self.assertEquals(IProcessorConstants.ARCH_IPF, self.processor.setArchitecture(6))
        self.assertEquals(IProcessorConstants.ARCH_IPF, self.processor.getArchitecture())
        self.assertEquals(IProcessorConstants.ARCH_X64, self.processor.setArchitecture(9))
        self.assertEquals(IProcessorConstants.ARCH_X64, self.processor.getArchitecture())
    ...
    def test_set_get_processor_type(self):
        self.assertEquals(IProcessorConstants.PROC_TYPE_OTHER, self.processor.setProcessorType(1))
        self.assertEquals(IProcessorConstants.PROC_TYPE_OTHER, self.processor.getProcessorType())
        self.assertEquals(IProcessorConstants.PROC_TYPE_UNKNOW, self.processor.setProcessorType(2))
        self.assertEquals(IProcessorConstants.PROC_TYPE_UNKNOW, self.processor.getProcessorType())
        self.assertEquals(IProcessorConstants.PROC_TYPE_CENTRAL_PROCESSOR, self.processor.setProcessorType(3))
        self.assertEquals(IProcessorConstants.PROC_TYPE_CENTRAL_PROCESSOR, self.processor.getProcessorType())
        self.assertEquals(IProcessorConstants.PROC_TYPE_MATH_PROCESSOR, self.processor.setProcessorType(4))
        self.assertEquals(IProcessorConstants.PROC_TYPE_MATH_PROCESSOR, self.processor.getProcessorType())
        self.assertEquals(IProcessorConstants.PROC_TYPE_DSP_PROCESSOR, self.processor.setProcessorType(5))
        self.assertEquals(IProcessorConstants.PROC_TYPE_DSP_PROCESSOR, self.processor.getProcessorType())
        self.assertEquals(IProcessorConstants.PROC_TYPE_VIDEO_PROCESSOR, self.processor.setProcessorType(6))
        self.assertEquals(IProcessorConstants.PROC_TYPE_VIDEO_PROCESSOR, self.processor.getProcessorType())
