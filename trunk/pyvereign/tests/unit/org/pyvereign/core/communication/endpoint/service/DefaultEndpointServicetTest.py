...
class DefaultEndpointTest(unittest.TestCase):
    ...
    def test_try_add_endpoint_listener_with_none_uri(self):
        self.assertRaises(TypeError, DefaultEndpointService().addEndpointListener, None, EndpointListenerForTest())
        
    def test_try_add_endpoint_listener_with_none_listener(self):
        self.assertRaises(TypeError, DefaultEndpointService().addEndpointListener, "TCP://127.0.0.1:5050", None)
        
    def test_try_add_endpoint_listener_with_invalid_type_uri(self):
        self.assertRaises(TypeError, DefaultEndpointService().addEndpointListener, 123, EndpointListenerForTest())
    
    def test_try_add_endpoint_listener_with_invalid_type_listener(self):
        self.assertRaises(TypeError, DefaultEndpointService().addEndpointListener, "TCP://127.0.0.1:5050", "listener")
    ...
    def test_try_remove_endpoint_listener_with_none_uri(self):
        self.assertRaises(TypeError, DefaultEndpointService().removeEndpointListener, 1233)
        
    def test_try_remove_endpoint_listener_with_invalid_type_for_uri(self):
        self.assertRaises(TypeError, DefaultEndpointService().removeEndpointListener, None) 
    
    def test_create_endpoint_message(self):
        self.assertTrue(DefaultEndpointService().createEndpointMessage("TCP://127.0.0.1:5050", "TCP://127.0.0.1:5050", None))
        message = DefaultEndpointService().createEndpointMessage("TCP://127.0.0.1:5050", "TCP://127.0.0.1:5050", None)
        self.assertTrue(message.getDestination())
        self.assertEquals(EndpointAddress, message.getDestination().__class__)
        self.assertEquals("TCP://127.0.0.1:5050/", message.getDestination().toURI())
        self.assertTrue(message.getOrigin())
        self.assertEquals(EndpointAddress, message.getOrigin().__class__)
        self.assertEquals("TCP://127.0.0.1:5050/", message.getOrigin().toURI())
        
    def test_try_create_endpoint_message_with_none_origin(self):
        self.assertRaises(TypeError, DefaultEndpointService().createEndpointMessage, None, "TCP://127.0.0.1:5050", None)
    
    def test_try_create_endpoint_message_with_none_destination(self):
        self.assertRaises(TypeError, DefaultEndpointService().createEndpointMessage,"TCP://127.0.0.1:5050", None, None)
    
    def test_try_create_endpoint_message_with_invalid_type_in_origin(self):
        self.assertRaises(TypeError, DefaultEndpointService().createEndpointMessage, ("TCP", "127.0.0.1", 5050), "TCP://127.0.0.1:5050", None)
    
    def test_try_create_endpoint_message_with_invalid_type_in_destination(self):
        self.assertRaises(TypeError, DefaultEndpointService().createEndpointMessage, "TCP://127.0.0.1:5050", ("TCP", "127.0.0.1", 5050), None)
    ...
    def test_try_get_message_sender_with_none_uri(self):
        self.assertRaises(TypeError, DefaultEndpointService().getMessageSender, None)
    
    def test_try_get_message_sender_with_invalid_type_in_uri(self):
        self.assertRaises(TypeError, DefaultEndpointService().getMessageSender, 123)
    ...
    def test_try_get_endpoint_protocol_with_none_name(self):
        self.assertRaises(TypeError, DefaultEndpointService().getEndpointProtocolByName, None)
    
    def test_try_get_endpoint_protocol_with_invalid_type_in_name(self):
        self.assertRaises(TypeError, DefaultEndpointService().getEndpointProtocolByName, 123)
    
    def test_try_get_endpoint_protocol_with_non_existent_name(self):
        self.assertRaises(EndpointServiceError, DefaultEndpointService().getEndpointProtocolByName, "FTP")
